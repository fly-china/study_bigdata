 ...
 **/
public class DownLoadImg0619 {

    private static final String BASE_PATH = "G:\\知乎图片\\";

    public static void main(String[] args) throws Exception {
        String filePath = BASE_PATH + "321151616.txt";
        String imgPathPath = BASE_PATH + "321151616\\";
        ...
        try (FileReader reader = new FileReader(filePath);
            ...
            String urlStr = null;
            while ((urlStr = bufferedReader.readLine()) != null) {
                // 一次读入一行数据
                ArrayList<String> list = Lists.newArrayList(urlStr.substring(1, urlStr.length() - 1).split(";"));
                urlList.addAll(list);
